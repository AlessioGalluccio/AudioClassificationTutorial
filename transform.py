...
class AudioUtil:
    ...
    def rechannel(aud, new_channel):
        ...
        if sig.shape[0] == new_channel:
            ...
            # Convert from ono to stereo by duplicating the first channel
    ...
    def pad_trunc(aud, max_ms):
        ...
        if sig_len > max_len:
            ...
            # Length of padding to add at the beginning and end of the signal is chosen randomly between the two
